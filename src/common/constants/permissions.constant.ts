...
export const PERMISSION_CONFIG = {
  ...
  PLATFORM_MINIAPP: {
    ...
    scope: 'platform',
    actions: [
      { code: 'platform:miniapp', name: '小程序管理', isMenu: true, routePath: '/miniapp' },
      {
        code: 'platform:miniapp:category:list',
        name: '分类管理',
        isMenu: true,
        routePath: '/miniapp/categories',
      },
      { code: 'platform:miniapp:category:create', name: '新增分类' },
      { code: 'platform:miniapp:category:update', name: '编辑分类' },
      { code: 'platform:miniapp:category:delete', name: '删除分类' },
      { code: 'platform:miniapp:category:status', name: '启用/禁用分类' },
      {
        code: 'platform:miniapp:banner:list',
        name: '轮播图管理',
        isMenu: true,
        routePath: '/miniapp/banners',
      },
      { code: 'platform:miniapp:banner:create', name: '新增轮播图' },
      { code: 'platform:miniapp:banner:update', name: '编辑轮播图' },
      { code: 'platform:miniapp:banner:delete', name: '删除轮播图' },
      { code: 'platform:miniapp:banner:status', name: '启用/禁用轮播图' },
      {
        code: 'platform:miniapp:post:list',
        name: '信息管理',
        isMenu: true,
        routePath: '/miniapp/posts',
      },
      { code: 'platform:miniapp:post:audit', name: '审核信息' },
      { code: 'platform:miniapp:post:offline', name: '下架信息' },
      {
        code: 'platform:miniapp:member:list',
        name: '会员列表',
        isMenu: true,
        routePath: '/miniapp/members',
      },
      { code: 'platform:miniapp:member:status', name: '启用/禁用会员' },
      { code: 'platform:miniapp:member:remark', name: '保存会员备注' },
    ],
  },
  ...
  TENANT_WAREHOUSE: {
    ...
    actions: [
      ...
      },
      {
        ...
        name: '货位灯',
        isMenu: true,
        routePath: '/warehouse/ptl',
      },
      { code: 'tenant:ptl:controller', name: '货位灯控制器管理' },
      { code: 'tenant:ptl:binding', name: '货位灯绑定管理' },
      { code: 'tenant:ptl:task', name: '货位灯找货任务' },
